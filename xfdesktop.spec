...
Version  : 4.18.0
Release  : 34
URL      : https://archive.xfce.org/src/xfce/xfdesktop/4.18/xfdesktop-4.18.0.tar.bz2
Source0  : https://archive.xfce.org/src/xfce/xfdesktop/4.18/xfdesktop-4.18.0.tar.bz2
...
%prep
%setup -q -n xfdesktop-4.18.0
cd %{_builddir}/xfdesktop-4.18.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1671143026
