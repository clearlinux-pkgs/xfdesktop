...
Version  : 4.13.0
Release  : 14
URL      : http://archive.xfce.org/src/xfce/xfdesktop/4.13/xfdesktop-4.13.0.tar.bz2
Source0  : http://archive.xfce.org/src/xfce/xfdesktop/4.13/xfdesktop-4.13.0.tar.bz2
...
BuildRequires : pkgconfig(garcon-2)
...
export LANG=C
export SOURCE_DATE_EPOCH=1494947133
