...
Source0  : http://archive.xfce.org/src/xfce/xfdesktop/4.15/xfdesktop-4.15.1.tar.bz2
...
%prep
%setup -q -n xfdesktop-4.15.1
cd %{_builddir}/xfdesktop-4.15.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604522697
...
cp %{_builddir}/xfdesktop-4.15.1/COPYING %{buildroot}/usr/share/package-licenses/xfdesktop/dfac199a7539a404407098a2541b9482279f690d
%make_install
%find_lang xfdesktop
