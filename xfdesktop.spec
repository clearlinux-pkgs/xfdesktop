...
Source0  : http://archive.xfce.org/src/xfce/xfdesktop/4.14/xfdesktop-4.14.2.tar.bz2
...
%prep
%setup -q -n xfdesktop-4.14.2
cd %{_builddir}/xfdesktop-4.14.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1578949446
...
cp %{_builddir}/xfdesktop-4.14.2/COPYING %{buildroot}/usr/share/package-licenses/xfdesktop/dfac199a7539a404407098a2541b9482279f690d
%make_install
%find_lang xfdesktop
