...
%prep
%setup -q -n xfdesktop-4.15.0
cd %{_builddir}/xfdesktop-4.15.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1592588365
...
cp %{_builddir}/xfdesktop-4.15.0/COPYING %{buildroot}/usr/share/package-licenses/xfdesktop/dfac199a7539a404407098a2541b9482279f690d
%make_install
%find_lang xfdesktop
