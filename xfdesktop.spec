...
Source0  : https://archive.xfce.org/src/xfce/xfdesktop/4.16/xfdesktop-4.16.1.tar.bz2
...
%prep
%setup -q -n xfdesktop-4.16.1
cd %{_builddir}/xfdesktop-4.16.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661289830
...
cp %{_builddir}/xfdesktop-%{version}/COPYING %{buildroot}/usr/share/package-licenses/xfdesktop/dfac199a7539a404407098a2541b9482279f690d
%make_install
%find_lang xfdesktop
